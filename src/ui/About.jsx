  ...
  return (
    <div
      ...
      <div className="w-full md:w-[40%] md:pl-10 text-stone-50">
        <h1 className="text-2xl sm:text-3xl md:text-4xl leading-8 sm:leading-10 md:leading-[45px] font-semibold mb-4 sm:mb-6 tracking-[1px] sm:tracking-[2px] pr-0 sm:pr-20 md:pr-80">
        ...
        <p className="text-sm sm:text-base md:text-[17px] text-justify tracking-[1px] sm:tracking-[1.5px]">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aut atque
          dolores corporis reiciendis sed, porro, iusto molestiae vitae commodi
          iure mollitia fuga harum odit magni reprehenderit deleniti doloremque
          similique consequatur. Lorem ipsum dolor sit amet, consectetur
          adipisicing elit.
        </p>
      </div>
