...
import IMG_1 from "../../public/afg_img/KBL/kbl1.jpeg";
import IMG_2 from "../../public/afg_img/KBL/kbl2.jpg";
import IMG_3 from "../../public/afg_img/KBL/kbl3.jpg";
import IMG_4 from "../../public/afg_img/KBL/kbl4.jpg";
...
export default function TourFullDetails() {
  ...
  const [isExpandedDay1, setIsExpandedDay1] = useState(false);
  const [isExpandedDay2, setIsExpandedDay2] = useState(false);
  const [isExpandedDay3, setIsExpandedDay3] = useState(false);
  const [isExpandedDay4, setIsExpandedDay4] = useState(false);
  const [isExpandedDay5, setIsExpandedDay5] = useState(false);

  const tour = useLoaderData();
  const { id, name, unitPrice } = tour;
  ...
  function handleExpandAll() {
    setIsExpandedDay1((prev) => !prev);
    setIsExpandedDay2((prev) => !prev);
    setIsExpandedDay3((prev) => !prev);
    setIsExpandedDay4((prev) => !prev);
    setIsExpandedDay5((prev) => !prev);
  }

  const handleImageChange = (e) => {
    const file = e.target.files[0];
    if (file) {
      setImage(URL.createObjectURL(file)); // آدرس موقت عکس
    }
  };
  ...
  return (
    <div className=" TourFullDetails ">
      ...
      {/*Screen navbar*/}
      {showNavbar && (
        <nav className="text-stone-100 fixed top-0 left-0 w-full z-50 bg-cyan-800 transition-all duration-700">
          <ul className="flex gap-15 text-[19px] py-4 justify-center items-center">
            <li
              onClick={() =>
                document
      ...
      {/* Gallery */}
      {id === 1 ? (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 h-[550px] p-4 mt-10 px-25">
          ...
          <div className="overflow-hidden rounded-2xl shadow-md col-start-3 col-end-5">
            <img
              src={IMG_2}
              alt="Kabul spot 1"
              className="w-full h-full object-cover transition-transform duration-500 hover:scale-105"
        ...
        <div className=" w-3xl my-10 mx-auto text-center py-20 font-semibold text-2xl">
          <p>This tour full details is under update pleae come back</p>
        </div>
      )}
      <div className="absolute right-27 bottom-25">
        <Button type="small" onClick={() => setOpenGallery((prev) => !prev)}>
          📸 Gallary
        </Button>
      </div>
      {openGallery && <Gallery setOpenGallery={setOpenGallery} />}
      {/*Tour name and details*/}
      <div className=" mt-10 flex gap-10 justify-between px-20 text-stone-100 py-15">
        <div className=" w-[70%]  flex flex-wrap justify-between gap-2.5">
          <h1 className=" font-semibold text-5xl w-[700px]">
            {name} Dreams: Awe-inspiring Odyssey
          </h1>
          ...
          <div className=" w-full mt-8">
            ...
            <ul className=" flex gap-10 flex-wrap ">
              <li className="flex items-center gap-3 w-[30%]">
              ...
              <li className="flex items-center gap-3 w-[30%]">
                ...
                <div class="trip-facts-text">
                  ...
                  <div className="value text-stone-50 text-[18px]">English</div>
                </div>
              </li>
              <li className="flex items-center gap-3 w-[30%]">
                <span class="icon-holder">
              ...
              <li className="flex items-center gap-3 w-[30%]">
                ...
                <div class="trip-facts-text ">
                  ...
                  <div className="value text-stone-50 text-[18px]">80</div>
                </div>
              </li>
            </ul>
          </div>
        </div>
        <div className="w-[30%] rounded-2xl overflow-hidden flex flex-col justify-between gap-4 shadow-stone-600 shadow-2xl TourFullDetails  border-stone-300 border self-start">
          ...
          <div className=" flex justify-between border-b-[1px] border-stone-400 ">
            <div className="w-[50%] text-center flex flex-col gap-2 border-r border-stone-400 mb-5 mt-5">
              ...
              <p className="font-semibold text-3xl">USD {unitPrice}</p>
      ...
      {/*Full detail navbar*/}
      <div className="border border-amber-300 px-20 pb-30 w-[70%]">
        <nav className=" text-stone-100">
          <ul className="flex gap-15 text-[19px] border-stone-200 border-b-[1px] py-4">
            <li>
              <a
                href=""
        ...
        <section id="overview" ref={overviewRef}>
          ...
          <p className="text-stone-300 mt-4">
            From soaring above the desert in a hot air balloon to standing atop
            the world’s tallest building and enjoying the thrills of the red
            dunes, each moment is curated for excitement, wonder, and
            ...
            dedicated <strong>travel consultant</strong> who will be in contact
            with you at every step, coordinating your itinerary, assisting with
            optional experiences, and ensuring your Dubai adventure flows
            seamlessly.
          </p>
          ...
          <ul className="wpte-trip-highlights text-stone-300">
            ...
            <li class="text-xl">
              <p p className="text-[15px]">
                ...
                Dubai Desert Conservation Reserve, complete with in-flight
            ...
            <li class="text-xl">
              <p p className="text-[15px]">
                ...
                access to the highest observation decks with gourmet treats and
            ...
            <li class="text-xl">
              <p p className="text-[15px]">
                ...
                city through traditional markets, museums, and local
                experiences.
              </p>
            </li>
            <li class="text-xl">
            ...
            <li class="text-xl">
              <p p className="text-[15px]">
                Six Emirates Day Tour – experience six of the seven Emirates in
                one unforgettable day (optional).
              </p>
            </li>
            <li class="text-xl">
              <p p className="text-[15px]">
            ...
            <li class="text-xl">
              <p className="text-[15px]">
                Full Support, Every Step – your consultant remains available for
                any last-minute plans, upgrades, or personalized arrangements.
              </p>
            </li>
          </ul>
        ...
        <section id="itinerary">
          ...
          <div className="flex flex-col">
            <div
              ...
              onClick={() => setIsExpandedDay1((prev) => !prev)}>
              ...
              <img
                onClick={() => setIsExpandedDay1((expand) => !expand)}
                src={Arrow_SVG}
                alt="arrow icon"
                className={
                  isExpandedDay1
            ...
            {isExpandedDay1 && (
              <div className=" self-end w-[93%] ">
                ...
                <p className="text-stone-300 mt-3">
                  ...
                  <strong>complimentary</strong> and not chargeable, providing a
                  buffer to ensure all guests are well-rested before the
                ...
                <p className="text-stone-300 mt-3">
                  ...
                  recommend dining spots, or suggest local experiences. Our goal
                  is to make sure your first day is relaxed, seamless, and
                  tailored to your preferences, setting the tone for an
          ...
          <div className="mt-7 flex flex-col">
            <div
              ...
              onClick={() => setIsExpandedDay2((prev) => !prev)}>
              <h2 className="text-stone-100 text-xl flex items-center gap-3">
                <img
                  src={CIRCLE_SVG}
                  alt="location icon"
                ...
                />
                Day 2 : Deluxe Hot Air Balloon Adventure & Burj Khalifa Premium
                Experience
              </h2>
              <img
                onClick={() => setIsExpandedAll((expand) => !expand)}
                src={Arrow_SVG}
                alt="arrow icon"
                className={
                  isExpandedDay2
                ...
                <p className="mt-3">
                  ...
                  <p className="mt-4">
                    ...
                    <p className="mt-4">
                      ...
                      breathtaking sunrise views and the desert’s golden dunes.
                    </p>
                  </p>
                </p>
                <div className="mt-4">
                  ...
                  <p className="mt-6">
                    <strong>Travel Consultant’s Note:</strong>
                    <p className="mt-2">
                      We will remain in contact during this time to assist with
                      any lunch recommendations or last-minute plans, ensuring
                      your morning adventure transitions smoothly into a
                      relaxing afternoon.
                    </p>
                  </p>
                  <p className="mt-6">
                    ...
                    <p className="mt-2">
                      Experience <strong>priority access </strong> to the 152nd,
                      153rd, and 154th floors, with access to the 148th & 125th
                      floors. Enjoy panoramic views of Dubai from the outdoor
                      terrace, complemented by <strong>gourmet treats </strong>{" "}
                      rincluding desserts, teas, coffee, and a glass of bubbly.
                    </p>
                    <p className="mt-2">
                  ...
                  <p className="mt-6">
                    ...
                    <ul className="mt-4 ml-4">
                      <li className="list-disc">
                        Return ride to hotel can be booked in advance during the
                        booking process
                      </li>
                      <li className="list-disc">
                      ...
                      <li className="list-disc">
                        Optional Dubai Aquarium tickets can be booked in advance
                        during the booking process (located inside Dubai Mall)
                      </li>
                      <li className="list-disc">
                  ...
                  <p className="mt-6">
                    ...
                    <p className="mt-2">
                      ...
                      provide guidance for optional visits to Dubai Mall or the
                      Aquarium. Our goal is to ensure your evening is seamless,
                      relaxed, and tailored to your preferences, allowing you to
                      enjoy Dubai at your own pace.
                    </p>
                  </p>
                </div>
              </div>
          ...
          <div className="mt-7 flex flex-col ">
            <div
              className="flex items-center justify-between hover:bg-cyan-800 cursor-pointer p-4"
              onClick={() => setIsExpandedDay3((prev) => !prev)}>
              <h2 className="text-stone-100 text-xl flex items-center gap-3">
                <img
                  src={CIRCLE_SVG}
                  alt="location icon"
              ...
              <div className=" text-stone-300 w-[93%] self-end">
                <p className="mt-2">
                  ...
                  <p className="mt-4">
                    ...
                    neighborhoods, markets, and waterways. Led by a local expert
                    guide, this immersive tour takes you through Al Fahidi
                    Historical Quarter, the Dubai Museum, and across the Creek
                    on a traditional Abra water taxi. Explore the Spice Souk,
                    Gold Souk, and hidden alleyways that reveal the authentic
                    soul of Dubai.
                  </p>
                </p>
                <p className="mt-4">
                  ...
                  <ul className="mt-4 ml-4">
                    ...
                    <li className="list-disc">
                      Visit to Al Fahidi Historical Neighbourhood & Dubai Museum
                    </li>
                    <li className="list-disc">
                ...
                <p className="mt-4">
                  ...
                  Lahbab Desert. Enjoy a thrilling 4WD dune bashing session, try
                  sandboarding, and capture stunning photos at sunset. Continue
                  to Al Khayma Desert Camp, where authentic Bedouin hospitality
                  awaits.
                </p>
                <p className="mt-4">
                  <strong>Highlights:</strong>
                  <ul className="mt-4 ml-4">
                    ...
                    <li className="list-disc">Unlimited Water & Soft Drinks</li>
                  </ul>
                </p>
                <p className="mt-4">
                ...
                <p className="mt-4">
                  <strong>Travel Consultant’s Note:</strong>
                  <p className="mt-2">
                    We will personally coordinate your day to ensure everything
                    runs smoothly. After your morning tour, we will recommend
                    great local spots for lunch, confirm your afternoon pickup,
                    and be available throughout the day to make sure your
                    experience feels seamless and personalized.
                  </p>
                </p>
              </div>
            )}
          ...
          <div className="mt-7 flex flex-col ">
            <div
              className="flex items-center justify-between hover:bg-cyan-800 cursor-pointer p-4"
              onClick={() => setIsExpandedDay4((prev) => !prev)}>
              <h2 className="text-stone-100 text-xl flex items-center gap-3">
                <img
                  src={CIRCLE_SVG}
                  alt="location icon"
            ...
            {isExpandedDay4 && (
              <div className=" text-stone-300 w-[93%] self-end">
                <p className="mt-4">
                  This day is <strong>completely optional</strong> and designed
                  to put <strong>your in full control</strong>. Guests can
                  select activities in advance during the booking process or
                  create their own adventure on the day. Your dedicated travel
                  consultant will remain in touch to assist with
                ...
                <ul className="mt-4 ml-4">
                  <li className="list-disc">
                    ...
                    Michelin-starred restaurants, cruising through Jumeirah, and
                    taking in iconic sights.
                  </li>
                  <li className="list-disc">
                    Alternatively, rent a <strong>Rolls Royce Ghost</strong> for
                    an ultra-luxury shopping experience and explore the city in
                    style. Duration: Flexible
                  </li>
                </ul>
                <p className="mt-4">
                ...
                <ul className="mt-4 ml-4">
                  ...
                  <li className="list-disc">
                    Duration: Full day but also flexible (Your ticket will allow
                    you full day stay), Starts from your hotel with private
                    transfer you decide where it ends
                  </li>
                </ul>
                <p className="mt-4">
                  <p>
                    ...
                    <p className="mt-2">
                      ...
                      luxury car, a day of waterpark fun, a full Emirates tour,
                      or your own independent adventure, we be available to
                      assist with any last-minute changes, bookings, or special
                      requests. Our goal is to ensure your day flows seamlessly
                      and matches your personal preferences — giving you
                      complete freedom while keeping everything effortless.
                    </p>
                  </p>
                </p>
              </div>
          ...
          <div className="mt-7 flex flex-col ">
            <div
              className="flex items-center justify-between hover:bg-cyan-800 cursor-pointer p-2"
              onClick={() => setIsExpandedDay5((prev) => !prev)}>
              <h2 className="text-stone-100 text-xl flex items-center gap-3">
                <img
                  src={LOC_SVG}
                  alt="location icon"
            ...
            {isExpandedDay5 && (
              <div className=" text-stone-300 w-[93%] self-end">
                <p className="mt-4">
                  On Day 5, the choice is <strong>completely yours</strong>. You
                  may conclude your Dubai adventure and take your unforgettable
                  memories home, or, if your heart desires, continue your
                  journey and stay as long as you wish.
                </p>
                <p className="mt-4">
                ...
                <ul className="mt-4 ml-4">
                  <li className="list-disc">
                    ...
                    you to the airport with a warm farewell, ensuring a seamless
                    end to your trip.
                  </li>
                  <li className="list-disc">
                ...
                <p className="mt-4">
                  ...
                  <strong>unique, fully customizable experience</strong>, and it
                  <strong>doesn’t end until you decide</strong>. Every moment is
                  guided by your preferences, ensuring the journey reflects your
                  pace, interests, and style.
                </p>
                <p className="mt-4">
                  <p>
                    <strong>Travel Consultant’s Note:</strong>
                  ...
                  <p className="mt-4">
                    We will be available to coordinate your departure or assist
                    with any extended stay arrangements. Whether you’re heading
                    home or continuing your adventure, our goal is to make sure
                    your experience remains effortless, memorable, and tailored
                    completely to you.”
                  </p>
                </p>
              </div>
          ...
          <div>
            <div>
              ...
              <ul className="wpte-trip-highlights includes text-stone-300 ">
                <li>
                  A dedicated personal Travel Consultant to guide and assist you
              ...
              <ul className="wpte-trip-highlights excludes text-stone-300 ">
                <li>
                  Pick-up after the Burj Khalifa “At The Top” Premium Experience
                  (Optional).
                </li>
        ...
        <section id="info">
          ...
          <ul class="list-disc text-stone-300 mt-8 ml-4">
            <li>
              ...
              <br />
              All services marked as <strong>(Optional)</strong> throughout the
              itinerary are <strong>not included</strong> in the base package
              price. These can be added during the booking process for an{" "}
              <strong>enhanced, fully customized experience</strong> tailored to
              your preferences.
            </li>
            <li>
            ...
            <li>
              ...
              touch throughout your journey to assist with any special requests,
              last-minute changes, or additional arrangements.
            </li>
          </ul>
          <hr className="border-[1px] border-cyan-900 mt-13" />
        </section>
