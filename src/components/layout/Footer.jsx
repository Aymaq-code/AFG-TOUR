...
export default function Footer() {
  return (
    <footer className=" relative mt-20 sm:mt-40 md:mt-60 py-8 sm:py-12 md:py-20 px-4 sm:px-8 md:px-15 rounded-[40px_40px_0_0] sm:rounded-[60px_60px_0_0] md:rounded-[80px_80px_0_0] text-gray-950 shadow-[0_0_4px_1px] shadow-black/20 overflow-x-hidden ">
      <div className=" flex flex-col lg:flex-row justify-between gap-8 sm:gap-12 md:gap-16">
        <div className="w-full lg:w-auto">
          <h2 className="font-semibold text-xl sm:text-2xl text-stone-900">
            About me
          </h2>
          <hr className="w-15 mb-4 text-stone-400 " />
          <p className="w-full sm:w-100 text-sm sm:text-base text-stone-800">
        ...
        <ul className="w-full lg:w-auto">
          ...
          <li className="py-1">
            <a
              ...
              target="_blank"
              className="text-sm sm:text-base flex gap-4 transition-all duration-300 text-[#4E342E] hover:text-[#6D4C41] ">
              <svg
          ...
          <li className="py-1">
            <a
              href="https://www.facebook.com/share/1FDvymsJN3/"
              target="_blank"
              className="text-sm sm:text-base flex gap-4 transition-all duration-300 text-[#4E342E] hover:text-[#6D4C41]">
              <svg
          ...
          <li className="py-1">
            <a
              href="https://www.linkedin.com/public-profile/settings/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_self_edit_contact_info%3BKYFD5FUIToGEXUgo3oQRfg%3D%3D"
              target="_blank"
              className="text-sm sm:text-base flex gap-4 transition-all duration-300 text-[#4E342E] hover:text-[#6D4C41]">
              <svg
        ...
        <div className="flex flex-col justify-between w-full lg:w-[35%] mb-12 md:mb-0">
          <h2 className="font-semibold text-xl sm:text-2xl text-stone-900">
            Subscribe
          </h2>
          <hr className="w-15 mb-4 text-stone-400 " />
          <input
            className="border-stone-500 border-1 p-2 outline-none rounded-[7px] mb-4 text-sm sm:text-base"
            type="text"
      ...
      <div className=" absolute bottom-2 font-semibold text-stone-400 w-full text-center ">
        <div>© {currentYear} by Abdul Rashid Aymaq. Frondend web developer</div>
      </div>
    </footer>
  );
}
