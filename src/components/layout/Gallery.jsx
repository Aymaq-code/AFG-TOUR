      ...
      <div className="relative w-full max-w-6xl h-auto flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
        ...
        <div className="relative w-full flex-1 flex justify-center">
          ...
          <div className="md:hidden absolute inset-x-0 top-1/2 transform -translate-y-1/2 flex justify-between px-4">
            <Button type="icon" onClick={prevImage} aria-label="Previous image">
              &larr;
            </Button>
            <Button type="icon" onClick={nextImage} aria-label="Next image">
              &rarr;
            </Button>
          </div>
        </div>
        ...
        {/* Image Counter */}
        <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black/40 text-white px-3 py-1 rounded-full text-sm md:text-base">
